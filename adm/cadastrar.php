<?php
    ...
    if($btnCadUsuario){
       ...
       if(in_array('',$dados)){
           ...
           $erro = true;
           $_SESSION['msg'] = "<center><label style='color: red;'>A sua senha deve conter 6 ou mais caracteres</label></center>";
       }else{
           ...
           if(($resultado_usuario) AND ($resultado_usuario->num_rows != 0)){
               $erro = true;
               $_SESSION['msg'] = "<center><label style='color: red;'>Este usuário já está sendo utilizado</label></center>";
           }
           ...
           if(($resultado_usuario) AND ($resultado_usuario->num_rows != 0)){
               $erro = true;
               $_SESSION['msg'] = "<center><label style='color: red;'>Este email já está sendo utilizado</label></center>";
           }
       }
       ...
       VALUES(
        ...
        if(mysqli_insert_id($conn)){
            $_SESSION['msgcad'] = "<center><label style='color: red;'>Cadastrado com sucesso</label></center>";
            header("Location: login.php");
        }else{
            $_SESSION['msg'] = "<center><label style='color: red;'>Erro ao cadastrar o usuário</label></center>";
        }
        }  
    }
?>
        ...
        <div class="container">
            ...
            ?>
                ...
                <form method="POST" action="" class="form-signin">
                    <!--<label>Nome</label>-->
                    <input type="text" name="nome" placeholder="Digite o seu nome" class="form-control"><br>
